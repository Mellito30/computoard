...
<body>
    ...
    <section class="Sec-Nav">
            ...
            <ul class="Barra-Nav">
                <li class="div-Sec">
                        <img class="Logo-ARM" src="img/LOGOARM.png" alt="LOGOAR">
                </li>
                <li class="div-Sec">
            ...
            <div class="div-Search_Filtro">
                ...
                <svg class="SVG-search"  stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="200px" width="200px"
                     xmlns="http://www.w3.org/2000/svg"><path d="M443.5 420.2L336.7 312.4c20.9-26.2 33.5-59.4 33.5-95.5 0-84.5-68.5-153-153.1-153S64
                      ...
                      85-35.2s62.3 12.5 85 35.2c22.7 22.7 35.2 52.9 35.2 84.9 0 32.1-12.5 62.3-35.2 84.9-22.7 22.7-52.9 35.2-85 35.2z"></path></svg>                         <input  class="Input-search" type="search" placeholder="Search" name="" id="">
                </div>
            <!-- Sección de filtro -->
